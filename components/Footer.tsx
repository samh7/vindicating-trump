  ...
  return (
    <div className="relative w-full h-screen">
      ...
      >
        ...
        <div className="no-underline my-6
        text-white
        ">Copyright: © 2024 D'Souza Media. All rights reserved.</div>

        <div className="underline">Crafted by samh7</div>
      </div>
    </div>
  );
}
