...
export default function TextSection() {
  return (
    <div
      className="flex flex-col relative z-[200] h-auto sm:py-[100px] items-center space-y-4
    ...
    >
      <div className="text-center w-[80%]">
        ...
        such a divisive figure on the national scene. The film also considers a
        danger that Lincoln warned about—the rise in America of a tyrant like
      ...
      <div className="text-center w-[80%]">
        ...
        Trump’s term in office reveals that the real lawlessness comes from
        Trump’s adversaries, who will stop at nothing to defeat him. The film
        spells out their tactics, from an invented accusation of treason to
      ...
      <div className="text-center w-[80%]">
        ...
        because he is the only one who has the power and the will to stop them.
        The film features interviews with Lara Trump, Trump’s daughter in law
        and co-chair of the Republican National Committee, and Alina Habba,
      ...
      <div className="text-center w-[80%]">
        ...
        Trump are hatched. This is Dinesh D’Souza’s most urgent and important
        film. It offers a fresh and eye-opening perspective on the most
        intriguing and controversial figure in America today. It will inform,
        amuse, infuriate, engage and finally motivate Americans of all
        backgrounds.
      </div>
    </div>
  );
